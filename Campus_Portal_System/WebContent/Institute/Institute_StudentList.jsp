...
<%
			   ...
			   PreparedStatement ps=con.prepareStatement("select * from student,student_academic,student_graduation,project_details,other_information where student.Prn_No=student_academic.Prn_No and student.Prn_No=student_graduation.Prn_No and student.Prn_No=project_details.Prn_No and student.Prn_No=other_information.Prn_No;");
